...
exp.add_report(ComparativeReport(algorithm_pairs=[("issue348-base","issue348-v20")]), outfile='base-v20-blind.html')
...
exp.add_report(
    ScatterPlotReport(
        format="png", attributes=["search_time"], filter_algorithm=["issue348-base","issue348-v20"], get_category=None, show_missing=True),
        outfile="base-v20-blind-search_time.png")
